...
> {
    ...
    /**
     * The 'contract' method is used to get the complete API contract inferred from all registered routes.
     *
     * Includes:
     * - Route paths
     * - HTTP methods
    ...
    /**
     * The `baseContract` method returns the API contract generated only from
     * the routes registered directly on this application instance.
     *
     * Unlike `contract`, it does not include routes inferred from controllers
     * or any merged route sources.
     *
     * Includes:
     * - Route paths
     * - HTTP methods
     ...
     * @example
     * ```ts
     * type API = typeof app.baseContract;
     *
     * API["/users/:id"].GET.params;
     * API["/users/:id"].GET.response;
     * ```
    ...
    /**
     * The `compiledContract` method is used to get the API contract
     * generated by the Spear compiler.
     *
     * Includes:
     * - Route paths
     * - HTTP methods
     ...
     * - Response
     *
     * Unlike `baseContract`, this contract contains only compiler-generated
     * routes and does not include routes registered directly on this
     * application instance.
     *
     * @example
     * ```ts
     * type API = typeof app.compiledContract;
     *
     * API["/users/:id"].GET.params;
     * API["/users/:id"].GET.response;
     * ```
     */
    get compiledContract() {
        return {} as TPrettify<AppRoutes>
    }
